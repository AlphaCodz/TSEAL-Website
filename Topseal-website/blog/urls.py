...
from . import views
from .views import HomePage, Details, LatestArticlePage, ContentDetails, TopNews, TopNewsDetail
...
urlpatterns = [
    ...
    re_path(r'topnews/(?P<pk>\d+)/$', TopNewsDetail.as_view(), name='topnews-detail'),
